        ...
        <div className="">
          ...
          <div className="grid grid-cols-2 gap-4 mt-5">
            <div className="flex items-center gap-4 bg-white/5 backdrop-blur-3xl p-5 rounded-lg border border-white/10 cursor-pointer">
              <span className="text-cyan-400 text-xl rounded-lg p-3 bg-white/10"><RiAiGenerate2 /></span>
              <p className="paragraph text-md ">AI Assitant to help you become Certified</p>
            </div>
            <div className="flex items-center gap-4 bg-white/5 backdrop-blur-3xl p-5 rounded-lg border border-white/10 cursor-pointer">
              <span className="text-cyan-400  text-xl rounded-lg p-3 bg-white/10"><VscVerifiedFilled /></span>
              <p className="paragraph text-md ">Get Certified After taking Amplitude test</p>
            </div>
            <div className="flex items-center gap-4 bg-white/5 backdrop-blur-3xl p-5 rounded-lg border border-white/10 cursor-pointer">
              <span className="text-cyan-400 text-lg rounded-lg p-3 bg-white/10"><MdClass /></span>
              <p className="paragraph text-md ">Classes for all fields</p>
            </div>
            <div className="flex items-center gap-4 bg-white/5 backdrop-blur-3xl p-5 rounded-lg border border-white/10 cursor-pointer">
              <span className="text-cyan-400 text-lg rounded-lg p-3 bg-white/10"><GiToken /></span>
              <p className="paragraph text-md ">Earn Reward Token After Activies</p>
            </div>
